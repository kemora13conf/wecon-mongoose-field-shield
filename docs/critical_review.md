...
- **Singleton registry:** Acceptable for a single process, but we should document lifecycle/reset guidance for multi-connection apps and SSR to avoid state bleed.
